    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM laborales2 LIMIT 10");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Autos juzgados laborales iss ::</title>
...
<div class="jumbotron mt-3">
  ...
  <h1>Jusgados laborales<br> (Par iss)</h1>
  <p class="lead">Aqui podras gestionar todos los autos de juzgados laborales (Par iss)</p>
  <a class="btn btn-lg btn-primary" href="create2.php" role="button">Nuevo registro</a>
 </div>
</div>
        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;"><a href="editarlaboral2.php?id=<?=$row->id?>" class="btn btn-outline-primary">Editar</a></td>
              <td style="text-align: center;"><a href="deletelaboral2.php?id=<?=$row->id?>" class="btn btn-outline-danger">Borrar</a></td>
