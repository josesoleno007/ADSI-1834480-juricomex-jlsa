...
<html lang="es">
  ...
  <h1 class="display-4">Crear nueva cita</h1>
  <p class="lead">Utiliza el siguiente formulario para crear una nueva cita.</p>
  <hr class="my-4">
  <form class="needs-validation" method="post" action="guardarcita.php" novalidate>
  <div class="form-row">
