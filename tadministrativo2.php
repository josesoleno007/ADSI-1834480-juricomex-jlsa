    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM tribunaladministrativo2 LIMIT 10");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Autos tribunal administrativo iss ::</title>
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" href="inmobiliaria.php">Juricomex</a>
  </li>
  <li class="nav-item">
    <a style="color:#636e72;" class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Autos</a>
  </li>
  <li class="nav-item">
...
<div class="jumbotron mt-3">
  ...
  <h1>Tribunal administrativo<br> (Par iss)</h1>
  <p class="lead">Aqui podras gestionar todos los autos del tribunal administrativo (Par iss)</p>
  <a class="btn btn-lg btn-primary" href="create5.php" role="button">Nuevo registro</a>
 </div>
</div>
        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="color:#FFFFFF; text-align: center;"><?=$row->tproceso?></td>
              <td style="color:#FFFFFF; text-align: center;"><?=$row->tema?></td>
              <td style="text-align: center;"><a href="editarta2.php?id=<?=$row->id?>" class="btn btn-outline-primary">Editar</a></td>
              <td style="text-align: center;"><a href="deleteta2.php?id=<?=$row->id?>" class="btn btn-outline-danger">Borrar</a></td>
