    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM tsuperior1");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Crear autos Tribunal superior ::</title>
...
<ul class="nav nav-tabs">
  ...
  <div class="jumbotron mt-3">
    ...
    <h1>Crear nuevo registro Tibunal superior - Juricomex <br>(Auto)</h1>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
       <form class="needs-validation"  method="post" action="guardarts1.php" >
  <div class="form-row">
