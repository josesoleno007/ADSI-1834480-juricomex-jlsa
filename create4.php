    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM tsuperior2");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Crear autos tribunal superior iss::</title>
...
<ul class="nav nav-tabs">
  ...
  <div class="jumbotron mt-3">
    ...
    <h1>Crear nuevo registro tribunal superior - Par iss <br>(Auto)</h1>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-12">
      <form class="needs-validation"  method="post" action="guardarts2.php" >
  <div class="form-row">
