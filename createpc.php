    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM jpequeñascausas");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Crear autos juzgados pequeñas causas ::</title>
...
<ul class="nav nav-tabs">
  ...
  <div class="jumbotron mt-3">
    ...
    <h1>Crear nuevo registro - juzgado de pequeñas causas (Auto)</h1>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-12">
      <form class="needs-validation"  method="post" action="guardarpc.php" >
  <div class="form-row">
