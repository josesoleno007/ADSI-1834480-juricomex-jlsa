    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM jpequeñascausas LIMIT 10");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Autos juzgados Pequeñas causas ::</title>
...
<div class="jumbotron mt-3">
  ...
  <h1>Juzgados de pequeñas causas</h1>
  <p class="lead">Aqui podras gestionar todos los autos de juzgados pequeñas causas.</p>
  <a class="btn btn-lg btn-primary" href="createpc.php" role="button">Nuevo registro</a>
 </div>
</div>
        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;"><a href="editarpc.php?id=<?=$row->id?>" class="btn btn-outline-primary">Editar</a></td>
              <td style="text-align: center;"><a href="deletepc.php?id=<?=$row->id?>" class="btn btn-outline-danger">Borrar</a></td>
