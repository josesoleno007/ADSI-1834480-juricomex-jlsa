    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM tsuperior2 LIMIT 10");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Autos tribunal superior iss ::</title>
...
<div class="jumbotron mt-3">
  ...
  <h1>Tribunal superior<br> (Par iss)</h1>
  <p class="lead">Aqui podras gestionar todos los autos del tribunal superior (Par iss)</p>
  <a class="btn btn-lg btn-primary" href="create4.php" role="button">Nuevo registro</a>
 </div>
</div>
        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;"><a href="editarts2.php?id=<?=$row->id?>" class="btn btn-outline-primary">Editar</a></td>
              <td style="text-align: center;"><a href="deletets2.php?id=<?=$row->id?>" class="btn btn-outline-danger">Borrar</a></td>
