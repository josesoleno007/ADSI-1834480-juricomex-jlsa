    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM juzadministrativo2 LIMIT 10");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Autos juzgados Administrativos iss ::</title>
...
<div class="jumbotron mt-3">
  <img class="img-thumbnail" src="images/iss.png" alt="">
  <img class="img-thumbnail" src="images/gestion.png" alt="" width="150px" height="150px">
  <h1>Jusgados administrativos<br> (Par iss)</h1>
  <p class="lead">Aqui podras gestionar todos los autos de juzgados administrativos (Par iss)</p>
  <a class="btn btn-lg btn-primary" href="create3.php" role="button">Nuevo registro</a>
 </div>
</div>
        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;"><a href="editaradministrativo2.php?id=<?=$row->id?>" class="btn btn-outline-primary">Editar</a></td>
              <td style="text-align: center;"><a href="deleteadministrativo2.php?id=<?=$row->id?>" class="btn btn-outline-danger">Borrar</a></td>
