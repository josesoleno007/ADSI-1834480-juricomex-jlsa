    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM laborales2");
              $stmt->execute();
...
<ul class="nav nav-tabs">
  ...
  <div class="jumbotron mt-3">
    ...
    <h1>Crear nuevo registro juzgado laboral - Par iss <br>(Auto)</h1>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-12">
      <form class="needs-validation"  method="post" action="guardarlaboral2.php" >
  <div class="form-row">
