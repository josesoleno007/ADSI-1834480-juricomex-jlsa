    ...
    if (isset($_SESSION['id'])) {
       $servername = "localhost";  
        ...
        try {
              ...
              $stmt = $conn->prepare("SELECT * FROM laborales1 LIMIT 10");
              $stmt->execute();
...
<html lang="es">
  <head>
    ...
    <title>:: JURICOMEX | Autos juzgados laborales ::</title>
...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" href="users.php">Administrador</a>
  </nav>
...
<div class="jumbotron mt-3">
  ...
  <h1>Jusgados laborales<br> (Juricomex)</h1>
  <p class="lead">Aqui podras gestionar todos los autos de juzgados laborales (Juricomex)</p>
  <a class="btn btn-lg btn-primary" href="create.php" role="button">Nuevo registro</a>
 </div>
</div>
        ...
        <table class="table table-striped table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;"><a href="editarlaboral1.php?id=<?=$row->id?>" class="btn btn-outline-primary">Editar</a></td>
              <td style="text-align: center;"><a href="deletelaboral1.php?id=<?=$row->id?>" class="btn btn-outline-danger">Borrar</a></td>
