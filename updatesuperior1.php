<?php
    ...
    session_start();
        ...
        try {
              ...
              $stmt = $conn->prepare("UPDATE  tsuperior1 SET fechapublicacion = ?, radicacion = ?, demandante = ?, demandado = ?, juzgado = ?, proceso = ?, tema = ?, enlace = ? WHERE id = ?");
              $stmt->execute(array($fechapublic, $radicacion, $dte, $ddo, $juzgado, $proceso, $tema, $enlace, $id));
             header('location: tsuperior1.php');
